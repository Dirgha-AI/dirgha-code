...
export interface SessionStartResult { sessionId: string; model: string; }

export interface SessionResumeParams { sessionId: string; }
export interface SessionResumeResult { sessionId: string; turns: number; }

export interface PromptSubmitParams { sessionId: string; prompt: string; }
export interface PromptSubmitResult { streamId: string; }

export interface ApprovalRespondParams { requestId: string; decision: 'approve' | 'deny' | 'approve_once' | 'deny_always'; }
...
export interface SessionListResult {
  sessions: Array<{ id: string; createdAt: string; turns: number }>;
}
