...
import { defineOpenAICompatProvider, type OpenAICompatSpec } from './define-openai-compat.js';
import type { Provider } from './iface.js';

const OPENAI_REASONING_RX = /^o[1-9](?:-.+)?$/i;

export const OPENAI_PRESET: OpenAICompatSpec = {
  id: 'openai',
...
export const OPENROUTER_PRESET: OpenAICompatSpec = {
  id: 'openrouter',
...
export const NVIDIA_PRESET: OpenAICompatSpec = {
  id: 'nvidia',
...
export const FIREWORKS_PRESET: OpenAICompatSpec = {
  id: 'fireworks',
  defaultBaseUrl: 'https://api.fireworks.ai/inference/v1',
  apiKeyEnv: 'FIREWORKS_API_KEY',
};

export const DEEPSEEK_PRESET: OpenAICompatSpec = {
  id: 'deepseek',
...
export function fromPreset(preset: OpenAICompatSpec, overrides: { apiKey?: string; baseUrl?: string; timeoutMs?: number } = {}): Provider {
...
export const PRESETS: Record<string, OpenAICompatSpec> = {
