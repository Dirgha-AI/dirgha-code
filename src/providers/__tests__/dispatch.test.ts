...
describe('routeModel', () => {
  ...
  describe('NVIDIA NIM whitelist', () => {
    ...
    it('deepseek-ai/deepseek-v4-flash → openrouter (removed from NIM — hangs)', () => {
      expect(routeModel('deepseek-ai/deepseek-v4-flash')).toBe('openrouter');
    });
    it('moonshotai/kimi-k2.5 → openrouter (NOT nvidia — would 404)', () => {
