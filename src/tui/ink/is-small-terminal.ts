...
export function minFlushMs(): number { return isSmallTerminal() ? 200 : 80; }
/** Spinner interval (ms) — 200 on small terminals, 80 on desktop. */
export function spinnerIntervalMs(): number { return isSmallTerminal() ? 200 : 80; }
/** StatusBar tok/s tick interval (ms) — 3000 on small terminals, 1000 on desktop. */
export function statusbarTickMs(): number { return isSmallTerminal() ? 3000 : 1000; }
