...
```text
◈ dirgha · 1.4.0 · openrouter/tencent/hy3-preview:free
─────────────────────────────────────────────────────────
...
| Skill safety scanner (prompt-injection / supply-chain heuristics) | new in 1.4.0 | [`security/skill-scanner.ts`](./src_v2/security/skill-scanner.ts) |
| Knowledge base (compiled wiki via OpenKB + PageIndex) | new in 1.4.0 | [`cli/subcommands/kb.ts`](./src_v2/cli/subcommands/kb.ts) |
