...
├── 1.4.0.md               release notes (long-form)
├── 1.4.0-tweet.md         tweet thread draft for the release
├── 1.4.0-promo.mp4        45 s promo video (committed via Git LFS for files > 1 MB)
...
|---|---|---|
| **Source tag** `v1.4.0` | git tag on the commit that bumped `package.json` | `git tag v1.4.0 && git push origin v1.4.0` |
| **GitHub release** | `https://github.com/<org>/<repo>/releases/tag/v1.4.0` | `gh release create v1.4.0 -F changelog/1.4.0.md` |
| **npm package** | `https://npmjs.com/package/@dirgha/code/v/1.4.0` | `npm publish` (after tag + release) |
| **Promo media** | `changelog/1.4.0-promo.mp4`, attached to the GH release | `gh release upload v1.4.0 changelog/1.4.0-promo.mp4` |
| **Tweet thread** | `changelog/1.4.0-tweet.md` (NEVER posted before user confirms) | hand-drafted; posting is a separate step |
...
$EDITOR CHANGELOG.md              # add the 1.4.0 entry
$EDITOR changelog/1.4.0.md         # write the long-form notes
...
gh release create v1.4.0 \
  --title "1.4.0" \
  --notes-file changelog/1.4.0.md \
  changelog/1.4.0-promo.mp4

# 6. Publish to npm (needs OTP).
npm publish

# 7. Post the tweet — only after npm install -g @dirgha/code@1.4.0
