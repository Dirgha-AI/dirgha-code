...
export const PRICES = [
    ...
    {
        provider: "cerebras",
        model: "cerebras/llama-4-maverick-17b-128e",
        inputPerM: 0,
        outputPerM: 0,
        contextWindow: 1_000_000,
        family: "llama",
...
function inferFamily(id) {
    ...
    if (/hunyuan/.test(id) || /tencent\//.test(id))
        return "hunyuan";
    if (/ling/.test(id) || /ring/.test(id) || /inclusionai/.test(id))
        return "ling";
    return "other";
}
/**
...
const MODEL_FAILOVERS = {
    ...
    // deepseek-v4-pro → v4-flash fallback for transient errors
...
export function findFailover(modelId) {
    ...
    if (exact)
        return exact;
    // Then try family-aware alternatives
...
const MODEL_ALIASES = {
    ...
    hy3: "inclusionai/ring-2.6-1t:free",
};
...
export function listModelAliases() {
    return Object.entries(MODEL_ALIASES).map(([alias, model]) => ({
        alias,
        model,
    }));
}
