...
export function KeySetOverlay(props) {
    ...
    return (_jsxs(Box, { flexDirection: "column", borderStyle: "round", borderColor: theme.accent, paddingX: 2, paddingY: 1, marginTop: 1, children: [_jsxs(Text, { color: theme.accent, bold: true, children: ["API Key Required \u2014 ", props.keyName] }), _jsx(Text, { color: theme.textMuted, children: hint }), _jsxs(Box, { marginTop: 1, flexDirection: "row", children: [_jsx(Text, { color: theme.textPrimary, children: "Key: " }), _jsx(TextInput, { value: value, onChange: setValue, mask: masked ? "*" : undefined, placeholder: "paste your key here", onSubmit: (v) => {
                            if (v.trim())
                                props.onSave(v.trim());
