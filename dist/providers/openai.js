...
export class OpenAIProvider {
    ...
    constructor(config) {
        ...
        if (!this.apiKey)
            throw new ProviderError('OPENAI_API_KEY is required. Set it via one of: (1) export OPENAI_API_KEY=sk-... in your shell, (2) run `dirgha login --provider=openai --key=sk-...`, or (3) inside the CLI type /keys to open the keystore.', this.id);
