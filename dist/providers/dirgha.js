...
export class DirghaProvider {
    ...
    resolveApiKey() {
        ...
        if (envKey)
            return envKey;
        throw new ProviderError("No Dirgha auth token or OPENROUTER_API_KEY found. Run `dirgha login` or set your key.", this.id);
    }
