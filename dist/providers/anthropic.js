...
export class AnthropicProvider {
    ...
    constructor(config) {
        ...
        if (!this.apiKey)
            throw new ProviderError('ANTHROPIC_API_KEY is required. Set it via one of: (1) export ANTHROPIC_API_KEY=sk-ant-... in your shell, (2) run `dirgha login --provider=anthropic --key=sk-ant-...`, or (3) inside the CLI type /keys to open the keystore.', this.id);
