 ...
 */
import { appendLedger, ledgerScope, } from "../context/ledger.js";
...
function extractFacts(text) {
    ...
    for (const pat of FINDING_PATTERNS) {
        ...
        if (m?.[1])
            bullets.push(m[1].trim().slice(0, 120));
        if (bullets.length >= 5)
            break;
    }
...
//# sourceMappingURL=ledger-hook.js.map