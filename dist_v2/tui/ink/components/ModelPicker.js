...
export function ModelPicker(props) {
    ...
    let idx = 0;
    return (_jsxs(Box, { flexDirection: "column", borderStyle: "round", borderColor: palette.accent, paddingX: 1, width: width, children: [_jsxs(Box, { justifyContent: "space-between", children: [_jsx(Text, { color: palette.accent, bold: true, children: "model picker" }), _jsx(Text, { color: palette.textMuted, dimColor: true, children: "\u2191\u2193 enter \u00B7 1-9 \u00B7 esc" })] }), _jsx(Box, { marginTop: 1, flexDirection: "column", children: groups.map(group => (_jsxs(Box, { flexDirection: "column", marginBottom: 1, children: [_jsx(Text, { color: palette.brand, dimColor: true, children: group.provider }), group.items.map(m => {
                            const myIdx = idx;
                            idx += 1;
                            ...
                            return (_jsxs(Box, { gap: 1, paddingLeft: 1, children: [_jsx(Text, { color: isCursor ? palette.accent : palette.textMuted, children: prefix }), _jsx(Text, { color: palette.textMuted, dimColor: true, children: num }), _jsx(Text, { color: isCursor ? palette.textPrimary : isCurrent ? palette.accent : palette.textMuted, bold: isCursor, children: m.label ?? m.id }), m.tier !== undefined && (_jsx(Text, { color: tierColor, dimColor: !isCursor, children: m.tier }))] }, m.id));
                        })] }, group.provider))) }), _jsx(Box, { borderStyle: "single", borderTop: true, borderBottom: false, borderLeft: false, borderRight: false, borderColor: palette.borderIdle, children: _jsxs(Box, { gap: 1, children: [_jsx(Text, { color: palette.textMuted, dimColor: true, children: "\u2192" }), _jsx(Text, { color: palette.accent, children: selected?.id ?? props.current })] }) })] }));
}
