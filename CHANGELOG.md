...
The 1.3.0 features were built using `dirgha -m hy3` (Tencent Hunyuan-3 preview, free via OR) as the implementation worker. The promo video at `/tmp/dirgha-promo/renders/dirgha-promo_2026-04-25_19-19-09.mp4` was authored by hy3 from a brief and rendered by hyperframes 0.4.26.
